...
public class DlgBookingRegistrasi extends javax.swing.JDialog {
    ...
    private int i=0,kuota=0, statusbooking=9;
    ...
    private void initComponents() {
        ...
        TanggalBooking.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-07-2022 13:49:51" }));
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-07-2022 13:49:51" }));
        ...
        Status.setBounds(780, 70, 140, 23);

        jLabel21.setText("Status :");
        jLabel21.setName("jLabel21"); // NOI18N
        FormInput.add(jLabel21);
        jLabel21.setBounds(730, 70, 40, 23);
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        ...
        if(Status.getText().trim().equals("Terdaftar")){
            JOptionPane.showMessageDialog(null,"Maaf, Pasien Sudah Terdaftar di Registrasi");
        }else{
    ...
    */
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){            
            ...
            Status.setText(tbObat.getValueAt(tbObat.getSelectedRow(),23).toString());
        }
    }
